...
**Background:** Hrafn previously used `main` in some documentation and scripts, which caused 404 errors, broken CI refs, and contributor confusion (see [#2929](https://github.com/5queezer/hrafn/issues/2929), [#3061](https://github.com/5queezer/hrafn/issues/3061), [#3194](https://github.com/5queezer/hrafn/pull/3194)). As of March 2026, all references have been corrected, stale branches cleaned up, and the `main` branch permanently deleted.
