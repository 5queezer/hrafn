...
- [ ] Initial feature-gate structure (`#[cfg(feature = "...")]`)
- [ ] Cherry-pick A2A commits (PR #4166)
- [ ] Cherry-pick config hot-reload (PR #3571)
- [ ] Fix P0 security issues (panics, mutex poisoning, rustls-webpki CVE)
