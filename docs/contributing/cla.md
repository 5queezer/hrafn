# Hrafn Contributor License Agreement (CLA)
...
property rights granted by contributors to Hrafn Labs. This agreement
protects both contributors and users of the Hrafn project.

By submitting a contribution (pull request, patch, issue with code, or any
other form of code submission) to the Hrafn repository, you agree to the
terms of this CLA.
...
- **"Contribution"** means any original work of authorship, including any
  modifications or additions to existing work, submitted to Hrafn Labs
  for inclusion in the Hrafn project.

- **"You"** means the individual or legal entity submitting a Contribution.

- **"Hrafn Labs"** means the maintainers and organization responsible
  for the Hrafn project at https://github.com/5queezer/hrafn.

---

## 2. Grant of Copyright License

You grant Hrafn Labs and recipients of software distributed by Hrafn
...
Hrafn that covers your Contribution, your patent license to the project
is not revoked.
...
This CLA does **not** transfer ownership of your Contribution to Hrafn
...
3. If your employer has rights to intellectual property you create, you
   ...
   has signed a corporate CLA with Hrafn Labs.

---

## 6. No Trademark Rights

This CLA does not grant you any rights to use the Hrafn name,
...
Hrafn Labs will maintain attribution to contributors in the repository
...
All Contributions accepted into the Hrafn project are licensed under
both:
...
By opening a pull request or submitting a patch to the Hrafn repository,
...
https://github.com/5queezer/hrafn/issues

---

*This CLA is based on the Apache Individual Contributor License Agreement
v2.0, adapted for the Hrafn dual-license model.*
