...
|---------|-----------|--------------|--------|
| **Hrafn cơ bản** | 3.4MB | <5MB | ✅ Hiện tại |
...
| Phần cứng | RAM | Hrafn (cơ bản) | Hrafn (full security) | Trạng thái |
|----------|-----|-----------------|--------------------------|--------|
...
**Ngay cả với full security, Hrafn chỉ dùng <5% RAM trên board $10.**

---

## 5. Tính hoán đổi: mọi thứ vẫn pluggable

### Cam kết chính của Hrafn: hoán đổi bất kỳ thứ gì
