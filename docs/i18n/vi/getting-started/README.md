...
| Tình huống | Lệnh |
|----------|---------|
| Có API key, muốn cài nhanh nhất | `hrafn onboard --api-key sk-... --provider openrouter` |
| Muốn được hướng dẫn từng bước | `hrafn onboard` |
| Đã có config, chỉ cần sửa kênh | `hrafn onboard --channels-only` |
...
- Thiết lập nhanh: `hrafn onboard --api-key "sk-..." --provider openrouter`
- Thiết lập hướng dẫn: `hrafn onboard`
- Kiểm tra môi trường: `hrafn status` + `hrafn doctor`
