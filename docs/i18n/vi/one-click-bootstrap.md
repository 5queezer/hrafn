...
Cách cài đặt và khởi tạo Hrafn nhanh nhất.
...
Mặc định là **chỉ ứng dụng** (build/cài Hrafn), yêu cầu Rust toolchain sẵn có.
...
Lệnh này build image Hrafn cục bộ và chạy thiết lập trong container, lưu config/workspace vào `./.hrafn-docker`.
