# Tài liệu tham khảo Providers — Hrafn
...
3. Biến môi trường dự phòng chung: `HRAFN_API_KEY`, sau đó là `API_KEY`
...
- Sau khi chuẩn hóa multimodal, Hrafn gửi payload hình ảnh qua trường `messages[].images` gốc của Ollama.
- Nếu chọn provider không hỗ trợ vision, Hrafn trả về lỗi rõ ràng thay vì âm thầm bỏ qua hình ảnh.
...
- Khám phá model: `hrafn models refresh --provider nvidia`
