...
```rust
// In your crate: use hrafn::tools::traits::{Tool, ToolResult};
...
```rust
// In your crate: use hrafn::channels::traits::{Channel, ChannelMessage, SendMessage};
...
提供商是 LLM 后端适配器。每个提供商将 Hrafn 连接到不同的模型 API。
...
```rust
// In your crate: use hrafn::providers::traits::Provider;
...
```rust
// In your crate: use hrafn::memory::traits::{Memory, MemoryEntry, MemoryCategory};
