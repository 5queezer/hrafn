# Hrafn Trademark Policy

**Effective date:** February 2026  
**Maintained by:** Hrafn Labs

---

## Our Trademarks

The following are trademarks of Hrafn Labs:

- **Hrafn** (word mark)
- **5queezer** (organization name)
- The Hrafn logo and associated visual identity

These marks identify the official Hrafn project and distinguish it from
...
The **only** official Hrafn repository is:

> https://github.com/5queezer/hrafn

Any other repository, organization, domain, or product claiming to be
"Hrafn" or implying affiliation with Hrafn Labs is unauthorized and
may constitute trademark infringement.

**Known unauthorized forks:**
- `openagen/hrafn` — not affiliated with Hrafn Labs

If you encounter an unauthorized use, please report it by opening an issue
at https://github.com/5queezer/hrafn/issues.

---

## Permitted Uses

You **may** use the Hrafn name and marks in the following ways without
prior written permission:

1. **Attribution** — stating that your software is based on or derived from
   Hrafn, provided it is clear your project is not the official Hrafn.

2. **Descriptive reference** — referring to Hrafn in documentation,
...
4. **Fork identification** — identifying your fork as "a fork of Hrafn"
...
You **may not** use the Hrafn name or marks in ways that:

1. **Imply official endorsement** — suggest your project, product, or
   organization is officially affiliated with or endorsed by Hrafn Labs.

2. **Cause brand confusion** — use "Hrafn" as the primary name of a
...
3. **Impersonate the project** — create repositories, domains, packages,
   or accounts that could be mistaken for the official Hrafn project.

4. **Misrepresent origin** — remove or obscure attribution to Hrafn Labs
   while distributing the software or derivatives.

5. **Commercial trademark use** — use the marks in commercial products,
   services, or marketing without prior written permission from Hrafn Labs.
...
you fork Hrafn, you must:

- Clearly state your project is a fork of Hrafn
- Link back to the official repository
- Not use "Hrafn" as the primary name of your fork
...
Contributors to the official Hrafn repository are protected under the
...
If you believe someone is infringing Hrafn trademarks:

1. Open an issue at https://github.com/5queezer/hrafn/issues
...
Hrafn Labs reserves the right to update this policy at any time. Changes
...
this policy governs use of the Hrafn name and brand.*
